...
public class HoaDonGTGTDTO {
    ...
    private HangHoaTrongHoaDonGTGT hangHoaItem;
    private List hangHoa;
    ...
    public HangHoaTrongHoaDonGTGT getHangHoaItem() {
        return hangHoaItem;
    }

    public void setHangHoaItem(HangHoaTrongHoaDonGTGT hangHoaItem) {
        this.hangHoaItem = hangHoaItem;
    }

    public List getHangHoa() {
        return hangHoa;
    }

    public void setHangHoa(List hangHoa) {
